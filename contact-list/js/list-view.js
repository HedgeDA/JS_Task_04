...
function fillContacts() {
  container.querySelector('.contacts-list').innerHTML = JSON.parse(loadContacts()).reduce((innerHTML, item) => {
      return innerHTML + `<li data-email="${item.email}" data-phone="${item.phone}"><strong>${item.name}</strong></li>`
    }, '')
}
